...
export default function ProcessSection() {
  ...
  const steps = [
    ...
    },
    {
      icon: FileSearch,
      number: '02',
      title: 'Анализ возможности участия',
      description: 'Изучаем требования и оцениваем перспективы участия'
    },
    {
      icon: FileCheck,
      number: '03',
      title: 'Подготовка и подача заявки',
      description: 'Собираем все необходимые документы, формируем и подаем заявку'
    },
    {
      icon: Gavel,
      number: '04',
      title: 'Участие в торгах',
      description: 'Участвуем в аукционе от вашего имени - по МЧД'
    },
    {
      icon: FileSignature,
      number: '05',
      title: 'Заключение контракта',
      description: 'Сопровождаем до подписания контракта и помогаем в получении независимой гарантии'
    }
  ]
