...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Стандартная подготовка занимает 2-5 рабочих дней. При срочной подготовке мы можем сократить срок от 3-х часов. Точные сроки зависят от сложности закупки и полноты предоставленных вами документов.'
    },
    {
